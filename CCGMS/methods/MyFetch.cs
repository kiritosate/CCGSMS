...
SELECT 
    ...
    ap.Name_of_Scholarship
        ...
        JOIN 
            tbl_Health_Data hd ON ir.Health_Data_ID = hd.Health_Data_ID  -- Corrected condition
        JOIN 
            tbl_Additional_Profile ap ON ir.Additional_Profile_ID = ap.Additional_Profile_ID;  -- Corrected condition
        ";
